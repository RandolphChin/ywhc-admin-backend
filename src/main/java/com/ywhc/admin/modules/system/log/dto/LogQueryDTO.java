...
public class LogQueryDTO extends BaseQueryDTO {
    ...
    @Schema(description = "操作模块 - 精确匹配")
    @QueryField(column = "module", type = QueryType.EQUAL)
    private String module;
    
    @Schema(description = "操作模块 - 模糊查询")
    @QueryField(column = "module", type = QueryType.LIKE)
    ...
    @Schema(description = "执行时间 - 大于")
    @QueryField(column = "execution_time", type = QueryType.GREATER_THAN)
    private Long executionTimeGt;
    
    @Schema(description = "执行时间 - 小于")
    @QueryField(column = "execution_time", type = QueryType.LESS_THAN)
    private Long executionTimeLt;
    
    @Schema(description = "执行时间范围")
    @QueryField(column = "execution_time", type = QueryType.BETWEEN)
    private List<Long> executionTimeRange;
    
    @Schema(description = "操作时间 - 大于等于")
    @QueryField(column = "create_time", type = QueryType.GREATER_EQUAL)
    private LocalDateTime createTimeStart;
    
    @Schema(description = "操作时间 - 小于等于")
    @QueryField(column = "create_time", type = QueryType.LESS_EQUAL)
