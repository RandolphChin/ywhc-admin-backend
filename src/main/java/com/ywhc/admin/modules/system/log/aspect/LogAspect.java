package com.ywhc.admin.modules.system.log.aspect;
...
public class LogAspect {
    ...
    @Around("@annotation(com.ywhc.admin.modules.system.log.annotation.LogAccess)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (logAccess != null) {
            ...
            sysLog.setOperationType(logAccess.operationType());
        }
